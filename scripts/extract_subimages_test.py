...
def main():
    ...
    if mode == 'pair':
        ...
        GT_folder = '/root/autodl-tmp/CARN/dataset/DIV2K_valid/HR'  # fix to your path
        LR_folder = '/root/autodl-tmp/CARN/dataset/DIV2K_valid/LR'  # fix to your path
        save_GT_folder = '/root/autodl-tmp/CARN/dataset/DIV2K_valid_sub/GT'
        save_LR_folder = '/root/autodl-tmp/CARN/dataset/DIV2K_valid_sub/LR'
